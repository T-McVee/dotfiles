...
hi("Include", { fg = colors.coral })
hi("Define", { fg = colors.coral })
hi("Macro", { fg = colors.bright_yellow })
hi("PreCondit", { fg = colors.coral })
...
-- Treesitter
hi("@variable", { fg = colors.bright_blue })
hi("@variable.builtin", { fg = colors.coral })
hi("@variable.parameter", { fg = colors.info })
hi("@variable.member", { fg = colors.info })
hi("@constant", { fg = colors.coral })
...
hi("RainbowDelimiterViolet", { fg = colors.bright_coral })
